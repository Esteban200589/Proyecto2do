<%@ Page Title="" Language="C#" MasterPageFile="~/main.Master" AutoEventWireup="true" CodeBehind="generar_pronostico.aspx.cs" Inherits="Presentacion.generar_pronostico" %>
                                ...
                                <div class="card-footer"> 
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12" style="text-align:center;">                     
                                            <asp:Button ID="btnGenerar"   class="btn btn-secondary" runat="server" Text="Guardar"   Width="90px" />                        
